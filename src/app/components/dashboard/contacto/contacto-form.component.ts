      ...
      if(this.uri !== "nuevo") {
        ...
        .subscribe(contacto => {
          ...
          this.formularioContacto = new FormGroup({
            'nombre': new FormControl(this.contacto.contacto_nombre, validaciones),
            'apellido': new FormControl(this.contacto.contacto_apellido, validaciones),
            'direccion': new FormControl(this.contacto.contacto_direccion, validaciones),
            'telefono': new FormControl(this.contacto.contacto_telefono, validaciones),
            'idCategoria': new FormControl(this.contacto.contacto_tipo,  Validators.required),
            'correo' : new FormControl(this.contacto.contacto_correo, validaciones)
          });
        });
      } else {
        this.formularioContacto = new FormGroup({
